...
public:
    ReverseRandomWalker() 
    {
        ...
        n.getParam("reverse_rand_drive_topic", drive_topic);
        ...
        odom_sub = n.subscribe(odom_topic, 1, &ReverseRandomWalker::odom_callback, this);
...
{
    ros::init(argc, argv, "reverse_random_walker");
    ReverseRandomWalker rrw;
    ros::spin();
    return 0;
}
