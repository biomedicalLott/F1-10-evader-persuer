...
public:
    Mux() {
        ...
        //channel for moving straight until obstacle detected
                int baa_mux_idx;
        std::string baa_drive_topic;
        n.getParam("baa_drive_topic", baa_drive_topic);
        n.getParam("baa_mux_idx", baa_mux_idx);
        add_channel(baa_drive_topic, drive_topic, baa_mux_idx);
        ...
        // Reverse Random driver
        int     reverse_random_walker_mux_idx;
        std::string reverse_rand_drive_topic;
        n.getParam("reverse_rand_drive_topic", reverse_rand_drive_topic);
        n.getParam("reverse_random_walker_mux_idx", reverse_random_walker_mux_idx);
        add_channel(reverse_rand_drive_topic, drive_topic, reverse_random_walker_mux_idx);
        // Straight walker 
        ...
        add_channel(straight_drive_topic, drive_topic, straight_walker_mux_idx);
        // reverse walker 
        int     reverse_walker_mux_idx;
        std::string rev_drive_topic;
        n.getParam("rev_drive_topic", rev_drive_topic);
        n.getParam("reverse_walker_mux_idx", reverse_walker_mux_idx);
        add_channel(rev_drive_topic, drive_topic, reverse_walker_mux_idx);
        ...
        std::string hard_brake_drive_topic;
        n.getParam("hard_brake_drive_topic", hard_brake_drive_topic);
        n.getParam("hard_braker_mux_idx", hard_braker_mux_idx);
        add_channel(hard_brake_drive_topic, drive_topic, hard_braker_mux_idx);
        // Evader Walker channel
        ...
        add_channel(evader_drive_topic, drive_topic, evader_walker_mux_idx);
